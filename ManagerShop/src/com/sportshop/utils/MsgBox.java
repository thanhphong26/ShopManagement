...
public class MsgBox {
    ...
    public static void alert(Component parent, String message) {
        ...
        JOptionPane.showMessageDialog(parent, message, "SPORTSHOP", JOptionPane.INFORMATION_MESSAGE, icon);
    }

    public static void warring(Component parent, String message) {
        ImageIcon icon = new ImageIcon("src\\com\\raven\\icon\\remove.png");
        JOptionPane.showMessageDialog(parent, message, "SPORTSHOP", JOptionPane.ERROR_MESSAGE);
    }

    public static boolean confirm(Component parent, String message) {
        ImageIcon icon = new ImageIcon("src\\com\\raven\\icon\\question.png");
        int result = JOptionPane.showConfirmDialog(parent, message, "SPORTSHOP", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, icon);
        return result == JOptionPane.YES_OPTION;
    }

    public static String prompt(Component parent, String message) {
        return JOptionPane.showInputDialog(parent, message, "SPORTSHOP", JOptionPane.INFORMATION_MESSAGE);
    }
